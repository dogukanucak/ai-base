    ...
    <div class={styles.serverManagement}>
      ...
      <div class={styles.statusCard}>
        <div class={styles.statusHeader}>
          <h3>Server Status</h3>
          <span class={`${styles.statusIndicator} ${status().isRunning ? styles.running : styles.stopped}`}>
        ...
        <div class={styles.metrics}>
          ...
          <div class={styles.metric}>
            ...
            <span>{Math.round(status().memory.used / 1024 / 1024)}MB / {Math.round(status().memory.total / 1024 / 1024)}MB</span>
          </div>
          <div class={styles.metric}>
